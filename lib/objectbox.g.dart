...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      ...
      lastPropertyId: const obx_int.IdUid(3, 4363650642507274422),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            ...
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 5554893440072006430),
            name: 'text',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(2, 8469457490244584725),
      lastIndexId: const obx_int.IdUid(2, 2607198788107676613),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    EmbeddingEntity: obx_int.EntityDefinition<EmbeddingEntity>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = EmbeddingEntity(textParam, embeddingsParam)
...
class EmbeddingEntity_ {
  ...
  static final id =
      obx.QueryIntegerProperty<EmbeddingEntity>(_entities[0].properties[0]);

  /// See [EmbeddingEntity.text].
  static final text =
      obx.QueryStringProperty<EmbeddingEntity>(_entities[0].properties[1]);

  /// See [EmbeddingEntity.embeddings].
  static final embeddings =
      obx.QueryHnswProperty<EmbeddingEntity>(_entities[0].properties[2]);
}
